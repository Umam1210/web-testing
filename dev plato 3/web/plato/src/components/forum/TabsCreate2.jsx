...
export default function Example() {
  return (
    <div className="flex max-w-3xl h-[600px] overflow-hidden justify-center rounded-md border border-gray-300 ">
      ...
      <div className="hidden sm:block">
        <div className="border-b border-gray-200">
          <nav className="-mb-px max-w-5xl flex space-x-8" aria-label="Tabs">
            {tabs.map((tab) => (
              <a
                key={tab.name}
                href={tab.href}
