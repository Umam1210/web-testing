const steps = [
  { id: 'Step 1', name: 'Data pribadi', href: '#', status: 'complete' },
  { id: 'Step 2', name: 'Isi KRS', href: '#', status: 'current' },
  { id: 'Step 3', name: 'Preview', href: '#', status: 'upcoming' },
  { id: 'Step 4', name: 'Preview', href: '#', status: 'upcoming' },
  { id: 'Step 5', name: 'Preview', href: '#', status: 'upcoming' },
  { id: 'Step 6', name: 'Preview', href: '#', status: 'upcoming' }
];

export default function LineHorizontalSteps() {
  return (
    <nav aria-label="Progress">
      <ol role="list" className="space-y-3 md:flex md:space-y-0 md:space-x-4">
        {steps.map((step) => (
